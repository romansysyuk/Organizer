...
CREATE  TABLE `users` (
  ...
  INSERT INTO `users`(username, password, enabled) VALUES ('petro','$2a$10$04TVADrR6/SPLBjsK0N30.Jf5fNjBugSACeGv1S69dZALR7lSov0y', true);
...
insert into `event` (eventDate, eventName, description, username) values ('1212-12-12', 'qweqweqwe', '1233 sdef 2112', 'petro')